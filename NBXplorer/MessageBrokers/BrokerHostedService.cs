...
namespace NBXplorer.MessageBrokers
{
	public class BrokerHostedService : IHostedService
	{
		...
		public BrokerHostedService(BitcoinDWaitersAccessor waiters, ChainProvider chainProvider, EventAggregator eventAggregator, IOptions<ExplorerConfiguration> config, IOptions<MvcNewtonsoftJsonOptions> jsonOptions)
		{
