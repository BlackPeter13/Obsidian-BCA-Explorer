...
namespace NBXplorer
{
	public static class Extensions
	{
		...
		class MVCConfigureOptions : IConfigureOptions<MvcNewtonsoftJsonOptions>
		{
		...
		public static IServiceCollection AddNBXplorer(this IServiceCollection services)
		{
			...
			services.AddSingleton<IConfigureOptions<MvcNewtonsoftJsonOptions>, MVCConfigureOptions>();
